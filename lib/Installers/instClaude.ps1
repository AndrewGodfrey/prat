...
function Install-ClaudeHarness {
    ...
    if ('installHomeClaudeMd' -notin $Suppress) {
        # Resolve layer fragments (prat, prefs, de) in prat-first order for base-first assembly.
        # Resolve-PratLibFile -ListAll returns highest-priority-first; reverse for base-first order.
        ...
        $pratCcFile = "$PSScriptRoot\..\agents\harness-specific\cc\prat-cc.md"
